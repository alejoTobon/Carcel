    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
                ...
                <div class="sidebar-brand-text mx-3">El Redentor </div>
            </a>
...
@endif
            ...
            <div class="sidebar-card d-none d-lg-flex">
                <img class="sidebar-card-illustration mb-2" src="img/carcel.webp" alt="...">
    ...
    <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        <span class="mr-2 d-none d-lg-inline text-gray-600 small">
            {{ Auth::check() ? (Auth::user()->rol === 'administrador' ? 'Administrador' : 'Guardia') : 'Invitado' }}
        </span>
    ...
    <script>
        $(document).ready(function() {
            $('#loadButton').on('click', function() {
                $('#dynamicContent').load('/prisionero');
            });
        });
    </script>
          @yield('scripts')
